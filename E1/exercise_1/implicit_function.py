...
def signed_distance_sphere(x, y, z, r, x_0, y_0, z_0):
    ...
    distance = np.sqrt(delta_x**2 + delta_y**2 + delta_z**2) - r
    return distance
    # ###############
...
def signed_distance_torus(x, y, z, R, r, x_0, y_0, z_0):
    ...
    a = np.sqrt(delta_x**2 + delta_z**2) - R
    distance = np.sqrt(a**2 + delta_y**2) - r
    return distance
    # ###############
...
def signed_distance_atom(x, y, z):
    ...
    # ###############
    # TODO: Implement
    distance_proton = signed_distance_sphere(x, y, z, proton_radius, proton_center[0], proton_center[1], proton_center[2])
    distance_orbit = signed_distance_torus(x, y, z, orbit_radius, orbit_thickness, proton_center[0], proton_center[1], proton_center[2])
    distance_electron = signed_distance_sphere(x, y, z, electron_radius, electron_center[0], electron_center[1], electron_center[2])

    distance = np.minimum(distance_proton, distance_orbit, distance_electron)
    return distance
    # ###############
